...
def main_loop():
    ...
    F"""
{kuning} ++----------------------------------------------------++
{putih}                TELEGRAM OTP SMSHUB BY API
{kuning} ++----------------------------------------------------++
{merah}                    _           _             _         
{merah}                   | |         | |           | |        
{merah}  ___ _ __ ___  ___| |__  _   _| |__     ___ | |_ _ __  
{merah} / __| '_ ` _ \/ __| '_ \| | | | '_ \   / _ \| __| '_ \ 
{merah} \__ \ | | | | \__ \ | | | |_| | |_) | | (_) | |_| |_) |
{merah} |___/_| |_| |_|___/_| |_|\__,_|_.__/   \___/ \__| .__/ 
{merah}                                                 | |    
{merah}                                                 |_|     
{kuning} ++----------------------------------------------------++
{putih}                   PASTIKAN SALDO CUKUP
{kuning} ++----------------------------------------------------++
          """
     )  
